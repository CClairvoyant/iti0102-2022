...
def meet_me(pos1, jump_distance1, sleep1, pos2, jump_distance2, sleep2) -> int:
    ...
    time1 = 0
    time2 = 0
    while pos1 - pos2 > 1000000 and that_is_enough < 5000000:
        ...
        that_is_enough += 1
    while pos2 - pos1 > 1000000 and that_is_enough < 5000000:
        difference = pos2 - pos1
        skip_time = difference // (sleep2 * sleep1)
        pos1 += jump_distance1 * (skip_time * sleep2)
        pos2 += jump_distance2 * (skip_time * sleep1)
        that_is_enough += 1
    while that_is_enough < 5000000:
        that_is_enough += 1
        if time1 <= time2:
            pos1 += jump_distance1
            time1 += sleep1
...
if __name__ == "__main__":
    ...
    print(meet_me(10000000, 1, 5, 1, 1, 2))
